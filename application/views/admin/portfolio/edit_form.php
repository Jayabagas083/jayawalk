            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/portfolio/edit') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <img class="img-bordered-sm" style="height: auto;width: 30%;" src="<?php echo base_url('assets/images/portfolio/'. $portfolio->foto ) ?>" alt="user image">
				...
				<div class="form-group">
                    ...
                    <input type="text" value="<?php echo $portfolio->judul ?>" class="form-control <?php echo form_error('judul') ? 'is-invalid':'' ?>" id="judul" placeholder="Judul" name="judul">
                    <div class="invalid-feedback">
