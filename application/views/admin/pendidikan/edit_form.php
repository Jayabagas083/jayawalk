            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/pendidikan/edit') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <img class="img-bordered-sm" style="height: auto;width: 30%;" src="<?php echo base_url('assets/images/pendidikan/'. $pendidikan->foto ) ?>" alt="user image">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $pendidikan->sekolah ?>" class="form-control <?php echo form_error('sekolah') ? 'is-invalid':'' ?>" id="sekolah" placeholder="Sekolah" name="sekolah">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $pendidikan->tahun_ajaran ?>" class="form-control <?php echo form_error('tahun_ajaran') ? 'is-invalid':'' ?>" id="tahun_ajaran" placeholder="Tahun Ajaran" name="tahun_ajaran">
                    <div class="invalid-feedback">
