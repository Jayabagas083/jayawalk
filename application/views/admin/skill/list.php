	...
	?>
		...
		<tr>
			...
			<td>
				...
				<a onclick="deleteConfirm('<?php echo site_url('admin/skill/delete/'.$b->id_skill) ?>')" href="#!" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
			<?php endforeach; ?>
		<?php 
			...
			<div class="modal-body">
				<form action="<?= base_url('master/skill/add')?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input name="keterangan" type="text" class="form-control" placeholder="Nama Anda">
					</div>			
