            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/pengalaman/edit') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <img class="img-bordered-sm" style="height: auto;width: 30%;" src="<?php echo base_url('assets/images/pengalaman/'. $pengalaman->foto ) ?>" alt="user image">
				...
				<div class="form-group">
                    ...
                    <input type="text" value="<?php echo $pengalaman->perusahaan ?>" class="form-control <?php echo form_error('perusahaan') ? 'is-invalid':'' ?>" id="perusahaan" placeholder="Perusahaan" name="perusahaan">
                    <div class="invalid-feedback">
